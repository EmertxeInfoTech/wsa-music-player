document.addEventListener("DOMContentLoaded", function () {
  ...
  const songs = [
    ...
    },
    {
      ...
      monthlyListner: 45,
      description:
        "Sid Sriram, born in Chennai and raised in the USA, is a versatile singer, songwriter, and composer. His journey in the music industry began with the soul-stirring 'Adiye' from the movie 'Kadal.' Sid's velvety voice and profound emotional delivery have made him a sought-after artist in both Indian and Western music scenes. Beyond playback singing, Sid has explored independent music, collaborating with various artists and consistently pushing the boundaries of musical expression.",
    },
    {
      title: "Once In Paris",
      duration: "2:12",
    ...
    },
    {
      title: "Believer",
      duration: "3:24",
      thumbnail: "./data/preview-img-5.jpg",
      src: "./data/track5.mp3",
      ...
      monthlyListner: 505,
      description:
        'Imagine Dragons, formed in Las Vegas in 2008, is a Grammy-winning American rock band that has redefined the alternative rock genre. Comprising Dan Reynolds, Daniel Wayne Sermon, Benjamin McKee, and Daniel Platzman, the band gained widespread acclaim with their debut album "Night Visions." Known for their powerful anthems, such as "Radioactive" and "Demons," Imagine Dragons crafts music that resonates with a broad audience. Their dynamic sound, characterized by emotive lyrics and electrifying performances, has solidified their place in the contemporary music landscape.',
    },
    {
      title: "Mental Manadhil",
      duration: "3:29",
      thumbnail: "./data/preview-img-6.jpg",
      src: "./data/track6.mp3",
      artist: "A.R Rahman",
      year: 2016,
      isVerfied: true,
      ...
      monthlyListner: 205,
      description:
        "A.R. Rahman, an Indian composer, singer, and music producer, is considered a maestro in the world of film music. Renowned for his work in Bollywood and international cinema, Rahman's compositions often blend Indian classical music with contemporary styles. He achieved global fame with his Academy Award-winning score for 'Slumdog Millionaire' and continues to be a prolific and influential figure in the music industry.",
    },
  ];
